...
namespace Library_Management_System.Helper
{
    ...
    {
        public static readonly Color PrimaryMaroon = Color.FromArgb(128, 0, 0);
        public static readonly Color PrimaryMaroonDark = Color.FromArgb(102, 0, 0);
        public static readonly Color PrimaryMaroonLight = Color.FromArgb(153, 0, 0);
        public static readonly Color SecondaryMaroon = Color.FromArgb(128, 0, 32);
        public static readonly Color SecondaryMaroonDark = Color.FromArgb(102, 0, 26);
        public static readonly Color SecondaryMaroonLight = Color.FromArgb(153, 0, 38);
        public static readonly Color AccentMaroon = Color.FromArgb(150, 0, 38);
        public static readonly Color AccentMaroonHover = Color.FromArgb(180, 0, 45);
