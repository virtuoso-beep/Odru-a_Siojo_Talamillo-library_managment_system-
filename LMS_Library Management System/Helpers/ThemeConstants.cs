...
namespace LMS_Library_Management_System.Helper
{
    public static class ThemeConstants
    {
        ...
        // Sidebar Colors
        public static readonly Color SidebarBackground = Color.FromArgb(120, 0, 0);    // #780000
        public static readonly Color SidebarButton = Color.FromArgb(128, 0, 32);       // #800020
        public static readonly Color SidebarButtonActive = Color.FromArgb(150, 0, 0);  // #960000
        public static readonly Color SidebarAdministrator = Color.FromArgb(160, 0, 0); // #A00000
