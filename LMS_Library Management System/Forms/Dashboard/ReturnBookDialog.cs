    ...
    public class ReturnBookDialog : Form
    {
        ...
        private void SetupDialog()
        {
            ...
            Button btnCancel = new Button
            {
                ...
                BackColor = Color.FromArgb(240, 220, 190),
                FlatStyle = FlatStyle.Flat,
                FlatAppearance = { BorderSize = 0 },
                Size = new Size(90, 38),
            ...
            btnCancel.MouseEnter += (s, e) => btnCancel.BackColor = Color.FromArgb(230, 210, 180);
            btnCancel.MouseLeave += (s, e) => btnCancel.BackColor = Color.FromArgb(240, 220, 190);
